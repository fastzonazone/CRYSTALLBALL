...
const LandingPage = () => {
  ...
  return (
    <div className="relative min-h-screen flex items-center justify-center overflow-hidden bg-gradient-to-br from-background-dark via-background-dark to-background-dark text-white px-6 md:px-12 lg:px-24">
